...
from tronpy.keys.abi import build_default_registry
...
if __name__ == '__main__':
    ...
    t = Tron()
    txi = t.get_transaction_info('eb47b9779a759203899d46f2bda75c0335405f7bcba838aad8781697f216b177')
    cnr = t.get_contract('TEkxiTehnzSmSe2XqrBj4w32RUN966rdz8')
    print(list(cnr.events.Transfer.processReceipt(txi)))
